...
%             \begin{varwidth}{\textwidth}
%             % \vspace{-5pt}
%             \itshape$\color{lightpink}^{\boldsymbol{*}}$Pre-hydro $\neq$ glasma, extrapolate $\hat{q}_\mathrm{neq}(\tau)$ to as early $\tau$ as possible!
%             \end{varwidth}
%         \end{untitledcustombox}
%     \end{center}
% \end{frame}
...
%             \footnotesize
%                 \begin{itemize}
%                     \item {\color{lightgray}Medium $\rightarrow$ {\bfseries\color{palviolet} EKRT} model + hydro}\\[3pt]
%                     {\color{lightgray}Parametrize $\boldsymbol{\hat{q}}\propto K {\color{palviolet}\boldsymbol{\epsilon}}^{3/4}_{\color{palviolet}\mathbf{EKRT}}$, fit $K$ to $R_{AA}$
%                     \item {\color{lightgray}Jet quenching $\rightarrow$ {\bfseries BDMPS-Z}}}\\[15pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{1}{${\color{destacado}\boldsymbol{\Rightarrow}}$}}} 
...
%             \footnotesize
%                 \begin{itemize}
%                     \item {\color{lightgray}Medium $\rightarrow$ $\boldsymbol{\hat{q}}\propto t^{-\boldsymbol{\alpha}}$ {\bfseries expansion parameter $\boldsymbol{\alpha}$}}\\[3pt]
%                     {\color{lightgray}{\color{darkqhat}\bfseries Over-occupied} and {\color{lightqhat}\bfseries under-occupied} systems}
%                     \item {\color{lightgray}Jet quenching $\rightarrow$ {\bfseries improved opacity expansion}}
...
%                     \\[15pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{1}{${\color{destacado}\boldsymbol{\Rightarrow}}$}}} 
%                     \item {\color{destacado}\bfseries\normalsize{$\mathfrak{Q}$ and $\mathfrak{v}_2$ sensitive to expansion $\boldsymbol{\alpha}$}}
%                 \end{itemize}
%                 % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
%         \end{center}
%         \column{.02\textwidth}
...
%             % \caption{\footnotesize\texttt{Medium-induced radiation with vacuum \\ propagation in pre-hydrodynamics phase}}
%             % \vspace{-5pt}
%             \includegraphics[width=1.05\textwidth]{images/Screenshot 2025-09-05 at 14.08.40.png}
%         \end{figure}
%         \column{.02\textwidth}
%         \column{.47\textwidth}
%         % \vspace{0.2cm}
...
%             \footnotesize
%                 \begin{itemize}
%                     \item {\color{lightgray}Medium $\rightarrow$ {\bfseries IP-Glasma + MUSIC + UrQMD}}\\[3pt]
%                     {\color{lightgray} Extrapolate $\hat{q}$ to early $\tau\in [0.1,0.4]\,\mathrm{fm/c}$\\ using hydro attractors}
%                     \item {\color{lightgray}Jet quenching $\rightarrow$ {\bfseries\color{palviolet}quenching framework} \\ with color coherence}\\[15pt]
%                     \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{1}{${\color{destacado}\boldsymbol{\Rightarrow}}$}}} 
...
%         \column{.02\textwidth}
%     \end{columns}
%     \blfootnote{\scriptsize Mehtar-Tani, Pablos, Tywoniuk \href{https://arxiv.org/abs/2101.01742}{\color{palviolet}\texttt{[2101.01742]}$^\text{\scalebox{0.9}{\faExternalLink}}$} \href{https://arxiv.org/abs/2402.07869}{\color{palviolet}\texttt{[2402.07869]}$^\text{\scalebox{0.9}{\faExternalLink}}$} Takacs, Tywoniuk \href{https://arxiv.org/abs/2103.14676}{\color{palviolet}\texttt{[2103.14676]}$^\text{\scalebox{0.9}{\faExternalLink}}$}}
%     \begin{tikzpicture}[overlay, remember picture]
%         \node[anchor=north west] 
...
%                 distance planet-satellite=4.0cm,
%                 planet size=4cm, 
%                 planet text width=3.1cm,
%                 /tikz/connection planet satellite/.append style={<-}
%                 }
%             \smartdiagram[constellation diagram]{
%                 {\Large\color{jyured}\bfseries $\boldsymbol{\hat{q}_\mathrm{neq}=0}$ \\ in pre-hydro?}, {\Large $R_{AA}$}, {\Large $v_2$} 
%             }
%         \end{figure}
%     \end{center}
%         \vspace{25pt}
...
%             \begin{varwidth}{\textwidth}
%             % \vspace{-5pt}
%             \itshape$\color{jyured}^{\boldsymbol{*}}$Pre-hydro $\neq$ glasma, $\hat{q}_\mathrm{glasma}$ not compatible with jet quenching medium approximations!
%             \end{varwidth}
%         \end{untitledcustombox}
%     \end{center}
% \end{frame}
...
%     \vspace{30pt}
%     \begin{center}
%         Add figures with $\hat{q}$ in glasma vs. BDMPS, color fields vs. indepdenent scatterings
%     \end{center}
% \end{frame}
...
%             \column{.54\textwidth}
%             \begin{center}
%                 \begin{custombox2}{\normalsize Glasma model with color domains}{raablue}
%                     \small
%                     \begin{varwidth}{0.92\textwidth}
%                     \begin{itemize}\itemsep0em 
%                         \itemsep0em
...
%                         \item Consecutive {\bfseries\color{raablue}static longitudinal electric fields}
...
%                         \item Extract jet quenching parameter $\boldsymbol{\hat{q}}$ and \\{\bfseries\color{palviolet} rate of medium-induced radiation $\boldsymbol{\mathrm{d}\Gamma/\mathrm{d}x}$}
%                         %  \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{raablue}\blacktriangleright}$}}} 
%                         \item {\bfseries Single tube} $\sim$ synchrotron radiation 
%                         \item {\bfseries Multiple tubes} $\Rightarrow$ rate decreases
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
%                 \begin{custombox2}{\normalsize Improvement}{jyured}
%                     \small
...
%                         \footnotesize
%                         \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{jyured}\blacktriangleright}$}}} 
%                         \item Longitudinal electric and magnetic fields\\ which {\bfseries\color{jyured}evolve in time}
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
%             \end{center}
...
%             \vspace{-10pt}
%             \begin{center}
%                 \includegraphics[width=0.92\columnwidth]{images/F1_qgA_worldline_mono.pdf}
%             \end{center}
...
%                         \item Interaction term with {\bfseries\color{raapink}classical gluon field $\boldsymbol{\mathcal{A}}$}
%                         \item Medium average $\langle \mathcal{A}(\vec{x}_\perp)\mathcal{A}(\vec{y}_\perp)\rangle\propto \delta^{(2)}(\vec{x}_\perp-\vec{y}_\perp)$
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
%             \end{center}
...
%             \begin{table}[t] 
%                 \centering
%                 % \caption{ The interaction matrix $V(x^+)$ for a dressed quark in the Fock space $\ket{q} + \ket{q g}$. The matrix elements are represented by diagrams. The straight line represents the quark, the black curled line the gluon, and the red curled line the background field. }
%                 % \label{tab:H}
%                 % Use: \begin{tabular{|lcc|} to put table in a box
%                 \begin{tabular}{c| c| c} %m{3cm} m{3cm}
%                 % \hline
%                 % 1st row
%                 \begin{tabular}{c}\footnotesize Fock \\ \footnotesize sector\end{tabular}
%                 & \multicolumn{1}{c|}{\footnotesize$\ket{q}$}
%                 & \multicolumn{1}{c}{\footnotesize$\ket{q g}$}\\ 
%                 \hline
%                 % 2nd row
%                 \begin{tabular}{c} \footnotesize$\bra{q}$\end{tabular}
%                 & 
%                 \begin{tabular}{c}
%                 \includegraphics[width=.18\textwidth]{images/T1_qA}
%                 \end{tabular}
%                 & 
%                 \begin{tabular}{c}
%                 \includegraphics[width=.18\textwidth]{images/T1_H_10}
%                 \end{tabular}
%                 \\
%                 % \hline
%                 % 3rd row
%                 \footnotesize$\bra{q g}$
%                 & 
%                 \begin{tabular}{c}
%                 \includegraphics[width=.18\textwidth]{images/T1_H_01}
%                 \end{tabular}
%                 & 
%                 \begin{tabular}{c c}
%                 \includegraphics[width=.18\textwidth]{images/T1_q_gA}
%                 &\includegraphics[width=.18\textwidth]{images/T1_g_qA}
%                 \end{tabular}
%                 \\
%                 % \hline
%                 \end{tabular}
...
%             % \vspace{-10pt}
%             \begin{center}
%                 \includegraphics[width=0.92\columnwidth]{images/quantummombroad.pdf}
%             \end{center}
...
%                         \footnotesize
%                         \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{raapink}\blacktriangleright}$}}} 
%                         \item Schr\"{o}dinger equation for {\bfseries\color{raapink} quark state $\boldsymbol{|\psi; x^+\rangle}$}\\ in {\bfseries\color{raapink}eikonal limit} contains only ${\color{raapink}\boldsymbol{\mathcal{A}_+}}$
%                         \item {\bfseries\color{raapink}Glasma field $\boldsymbol{\mathcal{A}}$} as numerical solution to CYM 
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
...
%                         \footnotesize
%                         \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{raablue}\blacktriangleright}$}}} 
%                         \item Quantum $\langle p_i^2(x^+) \rangle=\langle \psi;x^+|\hat{p}_i^2|\psi;x^+\rangle$
...
%                         \footnotesize
%                         \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{jyured}\blacktriangleright}$}}} 
%                         \item Higher Fock sector $\ket{q g}$ $\Rightarrow$ {\bfseries\color{jyured}gluon radiation}
%                     \end{itemize}
%                     \end{varwidth}
%                 \end{custombox2}
%             \end{center}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            ...
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2024, 2025}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
            }
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2021}
            {
            \draw[highlight on=<\Z>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<\Z>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\bfseries\X};
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            \draw[line width=0.7mm,-latex,isgold!20] (-0.2,0) -- (6.5+0.2,0);
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2021, 2025}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
            }
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2024}
            {
            \draw[highlight on=<\Z>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<\Z>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\bfseries\X};
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            ...
            % }}
            \vspace{-5pt}
            \includegraphics[width=0.9\textwidth]{images/Compare_Dissociation_vs_t_Singlet_Triplet_c.png}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        % \vspace{0.2cm}
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            \draw[line width=0.7mm,-latex,isgold!20] (-0.2,0) -- (6.5+0.2,0);
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2021, 2024}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
            }
            \foreach \X [evaluate=\X as \Y using int(\X-2020),count=\Z] in {2025}
            {
            \draw[highlight on=<\Z>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<\Z>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\bfseries\X};
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            ...
            % }}
            \vspace{-5pt}
            \includegraphics[width=\textwidth]{images/color_effect_v3.pdf}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        % \vspace{0.2cm}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                planet color=lightpink!15,      
                set color list={isgold!40, palteal!30},
                distance planet-satellite=4.2cm,
                planet size=3.8cm, 
                planet text width=3.5cm,
                /tikz/connection planet satellite/.append style={<-}
                }
            \smartdiagram[constellation diagram]{
                {\Large\color{lightpink}\textit{Heavy quarks} \\in \textbf{glasma$^{\color{lightpink}\boldsymbol{*}}$}}, {\Large $R_{AA}$}, {\Large $v_2$} 
            }
        \end{figure}
    \end{center}
    \vspace{25pt}
    \begin{center}
        \begin{untitledcustombox}{lightpink}
            ...
            \begin{varwidth}{\textwidth}
            % \vspace{-5pt}
            \itshape$\color{lightpink}^{\boldsymbol{*}}$Transport in glasma coupled to next stages!
            \end{varwidth}
        \end{untitledcustombox}
    \end{center}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            ...
            \foreach \X [evaluate=\X as \Y using int(\X-2018),count=\Z] in {2025}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
    ...
    %    \vspace{-13pt}
       \begin{figure}
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    \item {\color{lightgray}Matter $\rightarrow$ IP-Glasma + MUSIC hydro}
                    \item {\color{lightgray}Heavy quarks $\rightarrow$ MARTINI + Langevin + hadronization (coalescence + fragmentation)}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{untitledcustombox}{jyured}
            ...
            \begin{varwidth}{\textwidth}
            % \vspace{-5pt}
            \itshape$\color{jyured}^{\boldsymbol{*}}$Transport of heavy quarks in glasma not properly coupled to next stages!
            \end{varwidth}
        \end{untitledcustombox}
    \end{center}
\end{frame}
