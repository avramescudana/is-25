...
\tikzset{myarrow/.style={-Stealth}, line width=1.5pt}
\tikzset{
    myleftrightarrow/.style={Stealth-Stealth, line width=1.5pt}
}
        ...
        \column{.47\textwidth}
            ...
            \begin{custombox2}{\color{normal}Collision stages}{lightgray}
                ...
                \begin{itemize}\itemsep0em 
                    ...
                    \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{normal}\blacktriangleright}$}}} \item Local equilibrium {\scriptsize $\tau\lesssim 10\,\mathrm{fm/c}$}\\[1pt]
...
\begin{frame}[noframenumbering]
    ...
    % \framesubtitle{Weak coupling $\alpha_s\ll 1$}
    \vspace{-15pt}
    \begin{columns}[onlytextwidth,t]
        \column{.02\textwidth}
        \column{.47\textwidth}
...
\begin{frame}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \node[anchor=north west] 
        at ([xshift=0.05cm,yshift=-0.48cm]current page.north west) {\begin{plentalkbox}\scriptsize{\href{https://indico.cern.ch/event/1479384/contributions/6632069/}{{\color{isgold}Jet quenching in small systems$^\text{\scalebox{0.9}{\faHandOLeft}}$}}} \end{plentalkbox}};
    \end{tikzpicture}
\end{frame}
\setbeamertemplate{background}{}
...
\begin{frame}[noframenumbering]
    \frametitle{Jets as probes}
    \framesubtitle{of the later stages}
    \blfootnote{\scriptsize Apolinário \href{https://indico.cern.ch/event/1385550/}{{\color{jyured}\texttt{[CERN 24]$^\text{\scalebox{0.9}{\faExternalLink}}$}}}}
    % \begin{tikzpicture}[overlay, remember picture]
    %     \node[anchor=north west] 
...
\begin{frame}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \node[anchor=north west] 
        at ([xshift=0.05cm,yshift=-0.48cm]current page.north west) {\begin{plentalkbox}\scriptsize{\href{https://indico.cern.ch/event/1479384/contributions/6632069/}{{\color{isgold}Heavy quarks in small systems$^\text{\scalebox{0.9}{\faHandOLeft}}$}}} \end{plentalkbox}};
    \end{tikzpicture}
\end{frame}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \node[align=center] at (0,3) {
                ...
                \Large No medium interaction until QGP phase
            };
        \end{tikzpicture} 
    \end{center}
    \vspace{-5pt}    
...
%         \smartdiagramset{
%             planet size=3cm, 
%             satellite text width=2.2cm,
%             planet text width=2.0cm,
%             % distance planet-text=1.0,
%             distance planet-satellite=3.2cm,
%             /tikz/connection planet satellite/.append style={<-}
%         } 
%         \smartdiagram[constellation diagram]{
%             {\Large This talk}, {\footnotesize Glasma},{\footnotesize Jet broadening in glasma},{\footnotesize Jet quenching in glasma}, {\footnotesize Heavy quark diffusion in glasma}, {\footnotesize EKT}, Jets and heavy quarks during EKT
%         }
    ...
    \begin{center}
        \begin{figure}
            ...
            \begin{tikzpicture}[remember picture,overlay]
                ...
                (module2) to (module6);
                \draw[myarrow, draw=palblue!70, line width=1.5pt, bend left=15]
                (module5) to (module4);
                \draw[myarrow, draw=palblue!70, line width=1.5pt, bend right=15]
                (module5) to (module6);
                \draw[myleftrightarrow, draw=palteal!70, bend right=15]
                (module3) to (module4);
...
% {\transparent{0.3}\includegraphics[height=0.8\paperheight]{images/fig1_overview.pdf}}};
% }
\begin{frame}[plain,noframenumbering]
    \frametitle{}
    \begin{center}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                bubble center node color=gray!20,      
                set color list={isgold!40, palteal!30, palviolet!30}
                }
            \smartdiagramadd[bubble diagram]{
            ...
            \begin{tikzpicture}[remember picture,overlay]
                \draw[myarrow, draw=isgold!80, line width=1.5pt, bend right=40]
                (module2) to (module3);
                \draw[myarrow, draw=isgold!80, line width=1.5pt, bend left=40]
                (module2) to (module4);
                % \draw[myarrow, draw=palblue!70, line width=1.5pt, bend left=15]
                % (module5) to (module4);
                % \draw[myarrow, draw=palblue!70, line width=1.5pt, bend right=15]
...
% \setbeamertemplate{background}{
% \tikz[overlay,remember picture] \node[opacity=0.1, at=(current page.center), align=center] {\\[10pt]
% {\transparent{0.1}\includegraphics[width=0.95\paperwidth]{images/traj_charm_beauty.png}}};
% }
% \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{normal}\blacktriangleright}$}}} 
% \begin{frame}[plain,noframenumbering]{}
%     \begin{center}
...
\begin{frame}[plain, noframenumbering]
    ...
    \framesubtitle{Diffusion and momentum broadening}
    \vspace{10pt}
    \begin{center}
        \begin{itemize}\itemsep0em 
            \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{destacado}\blacktriangleright}$}}} 
            \item \begin{center}Classical transport for {\bfseries\color{palviolet}heavy quarks} and  {\bfseries\color{palteal}jets} in glasma fields, no back-reaction\end{center}
        \end{itemize}
        \vspace{10pt}
        \begin{tikzpicture}[]
            \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{images/traj_charm_beauty.png}};
            \draw<1>[palviolet,line width=1pt,fill=palviolet,fill opacity=0.1,rounded corners=3pt] (0.0, 0) rectangle (9.4, 5.2);
            \draw<1>[palteal,line width=1pt,fill=palteal,fill opacity=0.1,rounded corners=3pt] (9.6, 0) rectangle (15.2, 5.2);
        \end{tikzpicture}
    \end{center}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            ...
            \smartdiagramadd[bubble diagram]{
                \textit{Hard probes} \\ in \textbf{pre-equilibrium}, \textit{\footnotesize\color{isgold}Part 1}\\\textbf{\Large\color{isgold} Glasma}, \textit{\color{palteal}Jet} momentum \\ broadening
            }{}
            % \begin{tikzpicture}[remember picture,overlay]
            %     \draw[myarrow, draw=isgold!80, line width=1.5pt, bend right=40]
            %     (module2) to (module3);
...
\begin{frame}
    ...
    \end{center}
    \vspace{-20pt}
    \blfootnote{\scriptsize \textbf{DA}, Băran, Greco, Ipp, Müller, Ruggieri  \href{https://arxiv.org/abs/2307.07999}{{\color{custompink}\texttt{[2307.07999]}$^\text{\scalebox{0.9}{\faExternalLink}}$}}}
\end{frame}
        ...
        \begin{tikzpicture}
            ...
            \draw<1>[white,fill=white,fill opacity=0.9] (5.2,0.2) rectangle (13.0,6.8) node[opacity=1.0, pos=0.5, rotate=0, anchor=center, xshift=0.0 ,text width=7.5cm,align=center] {
                \begin{itemize}\itemsep0em 
                    ...
                    \\{\color{lightgray}\footnotesize $\approx$ dynamic quarks with finite $p^x$}\\[10pt]
                    % \\[10pt]
                        % \begin{itemize}\itemsep0em 
                        %     \setbeamertemplate{itemize items}{\raisebox{0.1em}{\scalebox{0.6}{${\color{lightgray}\blacktriangleright}$}}} 
                        ...
                        % \end{itemize}
                    \item \large Anisotropic $\langle \delta p^2_z\rangle>\langle \delta p^2_y\rangle$ \\{\color{lightgray}\footnotesize $\sim$ more $\delta p^2$ in longitudinal $z$ than transverse $y$}\\[10pt]
                    % \begin{itemize}\itemsep0em 
                        % \setbeamertemplate{itemize items}{\raisebox{0.1em}{\scalebox{0.6}{${\color{lightgray}\blacktriangleright}$}}} 
...
\begin{frame}[noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}
            \hspace{-15pt}\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=0.85\textwidth]{images/hp23_mom_broad_qhat_anis_wong_vs_qhat.pdf}};
            % \draw<1>[white, fill=white, fill opacity=0.9] (4.3,0.85) rectangle (5.4,5.5);
            \draw<1>[white,fill=white,fill opacity=0.9] (0.0,0.2) rectangle (5.2,6.8) node[opacity=1.0, pos=0.5, rotate=0, anchor=center, xshift=0.0 ,text width=6.5cm,align=center] {tg
                \begin{itemize}\itemsep0em 
                    \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{custompink}\blacktriangleright}$}}} 
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            ...
            \foreach \X [evaluate=\X as \Y using int(\X-2019),count=\Z] in {2021, 2023, 2025}
            {
...
\begin{frame}[t,noframenumbering]
    ...
    %    \vspace{-13pt}
       \begin{figure}
            ...
            % \caption{\texttt{Anisotropic momentum broadening \\ in the 2+1D Glasma}}
            % \vspace{-15pt}
            \includegraphics[width=1\textwidth]{images/strong_correlators_r.pdf}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        % \vspace{0.2cm}
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            \draw[line width=0.7mm,-latex,isgold!20] (-0.2,0) -- (7.5+0.2,0);
            \foreach \X [evaluate=\X as \Y using int(\X-2019),count=\Z] in {2020, 2023, 2025}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
    ...
    %    \vspace{-13pt}
       \begin{figure}
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    \item {\color{lightgray}Analytical glasma fields in dilute limit}
                    \item {\color{lightgray}Fokker-Planck equation for quarks}
                    \item {\color{lightgray}\bfseries More reliable than the $\boldsymbol{\tau}$-expansion}
                    \item {\color{lightgray}Compatible results with previous $\hat{q}$ estimates}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            ...
            \smartdiagramadd[bubble diagram]{
                \textit{Jets} in \\ \textbf{pre-equilibrium}, {\Large $R_{AA}$}, {\Large $v_2$}
            }{}
            % \begin{tikzpicture}[remember picture,overlay]
            %     \draw[myarrow, draw=isgold!80, line width=1.5pt, bend right=40]
            %     (module2) to (module3);
...
\begin{frame}[t]
    ...
    %    \vspace{-13pt}
       \begin{figure}
            ...
            \vspace{-5pt}
            \includegraphics[width=1.05\textwidth]{images/raa-vn-tauq_crop.pdf}
        \end{figure}
        \column{.02\textwidth}
        \column{.46\textwidth}
        % \vspace{0.2cm}
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    ...
                    \item {\color{lightgray}{\bfseries Energy loss suppressed in first $\boldsymbol{\sim 0.6\,\mathrm{fm/c}}$}}
                    \item {\color{lightgray}Fit $R_{AA}$, get different $v_2$}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
...
\begin{frame}[t,noframenumbering]
    ...
    %    \vspace{-13pt}
       \begin{figure}
        ...
        \begin{center}
            \setbeamertemplate{itemize item}{\raisebox{0.1em}{\scalebox{0.5}{${\color{lightgray}\blacktriangleright}$}}}
            {\Large\color{isgold} $\mathfrak{Q}$ and $\mathfrak{v}_2$ \\[10pt]}
            \footnotesize
                \begin{itemize}
                    \item {\color{lightgray}Improved opacity expansion for energy loss}
                    \item {\color{lightgray}Parametrize $\hat{q}(t)$, expansion parameter $\alpha$}
                    \item {\color{lightgray}{\color{darkqhat}Over-occupied} and {\color{lightqhat}under-occupied} systems}
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    ...
                    \item {\color{lightgray}Jets in IP-Glasma + MUSIC + UrQMD}
                    % \item {\color{lightgray}Quenching between $0.1\,\mathrm{fm/c}$ and $0.4\,\mathrm{fm/c}$}
                    \item {\color{lightgray}Extrapolate $\hat{q}$ to early times 0.1-0.4 fm/c\\ using hydrodynamic attractors}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                bubble center node color=gray!20,      
                set color list={isgold!40, palteal!30, palteal!30}
                }
            \smartdiagramadd[bubble diagram]{
                \textit{Hard probes} \\ in \textbf{pre-equilibrium}, \textit{\footnotesize\color{isgold}Part 1}\\\textbf{\Large\color{isgold} Glasma}, \textit{\color{palteal}Jet} momentum \\ broadening, \textit{\color{palteal}Jet} energy loss
            }{}
            \begin{tikzpicture}[remember picture,overlay]
                \draw[myleftrightarrow, draw=palteal!70, bend right=40]
                (module3) to (module4);
            \end{tikzpicture}
            ...
            \begin{center}
                ...
                \begin{custombox2}{\normalsize Quantum jets in glasma}{raapink}
                    ...
                    \begin{itemize}\itemsep0em 
                        ...
                        \footnotesize
                        \setbeamertemplate{itemize item}{\raisebox{0.2em}{\scalebox{0.7}{${\color{raapink}\blacktriangleright}$}}} 
                        \item Schr\"{o}dinger equation for the quark state \\ $\partial_{x^+}|\psi; x^+\rangle=-\mathrm{i}/2\,P^-|\psi; x^+\rangle$
                        \item Light-front Hamiltonian $P^-$ in eikonal limit \\
                        $P^-=g\int\mathrm{d}x^-\mathrm{d}^2\vec{x}_\perp \overline{\Psi}\gamma^+ {\color{jyured}\mathcal{A}_+}\Psi$
                        \item Light-cone component of classical glasma field $\color{jyured}\mathcal{A}_+$ from numerical solution to CYM
                    \end{itemize}
                    \end{varwidth}
                \end{custombox2}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                bubble center node color=gray!20,      
                set color list={isgold!40, palviolet!30}
                }
            \smartdiagramadd[bubble diagram]{
                \textit{Hard probes} \\ in \textbf{pre-equilibrium}, \textit{\footnotesize\color{isgold}Part 1}\\\textbf{\Large\color{isgold} Glasma}, \textit{\color{palviolet}Heavy quark} \\ diffusion
            }{}
            % \begin{tikzpicture}[remember picture,overlay]
            %     \draw[myarrow, draw=isgold!80, line width=1.5pt, bend right=40]
            %     (module2) to (module3);
...
\begin{frame}
    ...
    \end{center}
    \vspace{-20pt}
    \blfootnote{\scriptsize \textbf{DA}, Băran, Greco, Ipp, Müller, Ruggieri  \href{https://arxiv.org/abs/2307.07999}{{\color{Mahogany}\texttt{[2307.07999]}$^\text{\scalebox{0.9}{\faExternalLink}}$}}}
\end{frame}
        ...
        \begin{tikzpicture}
            ...
            \draw<1>[white,fill=white,fill opacity=0.9] (5.2,0.2) rectangle (13.0,6.8) node[opacity=1.0, pos=0.5, rotate=0, anchor=center, xshift=0.0 ,text width=7.5cm,align=center] {
                \begin{itemize}\itemsep0em 
                    ...
                    \\{\color{lightgray}\footnotesize $\neq$ dynamic quarks with finite $p_T$}\\[10pt]
                    % \\[10pt]
                        % \begin{itemize}\itemsep0em 
                        %     \setbeamertemplate{itemize items}{\raisebox{0.1em}{\scalebox{0.6}{${\color{lightgray}\blacktriangleright}$}}} 
                        %     \item \color{lightgray}\footnotesize Transverse $\langle \delta p^2_y\rangle$ increases with $p^x$
                        %     \item \color{lightgray}\footnotesize Longitudinal $\langle \delta p^2_z\rangle$ descreses with $p^x$\\[10pt]
                        % \end{itemize}
                    \item \large Anisotropic $\langle \delta p^2_L\rangle>\langle \delta p^2_T\rangle$ \\{\color{lightgray}\footnotesize $\sim$ more $\delta p^2$ in longitudinal $L$ than transverse $T$}\\[10pt]
                \end{itemize}
                };
        \end{tikzpicture}
    \end{center}
...
\begin{frame}[t,noframenumbering]
    \frametitle{Heavy quaks in glasma}
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            \draw[line width=0.7mm,-latex,isgold!20] (-0.2,0) -- (8.5+0.2,0);
            \foreach \X [evaluate=\X as \Y using int(\X-2017),count=\Z] in {2018, 2021, 2024}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    ...
                    \item {\color{lightgray}\bfseries Considering the glasma increases $\boldsymbol{v_2}$}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            ...
            \foreach \X [evaluate=\X as \Y using int(\X-2017),count=\Z] in {2021}
            {
            \draw[highlight on=<\Z>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<\Z>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\bfseries\X};
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    \item {\color{lightgray}Numerical glasma fields}
                    \item {\color{lightgray}Numerical heavy quarks using Wong's equations}
                    \item {\color{lightgray}\bfseries Dynamics compared to pQCD Langevin}
                    \item {\color{lightgray}Diffusion in glasma $\neq$ {\bfseries brownian motion}}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1]
            \draw[line width=0.7mm,-latex,isgold!20] (-0.2,0) -- (8.5+0.2,0);
            \foreach \X [evaluate=\X as \Y using int(\X-2017),count=\Z] in {2018, 2019, 2021}
            {
            \draw[highlight on=<0>] (\Y,0) circle[radius=3pt];
            \node[anchor=south,highlight on=<0>,fill=white,rotate=45,anchor=south
            west,inner sep=0pt] at (\Y,0.2) {\X};
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    ...
                    \item {\color{lightgray}Initialization with FONLL $p_T$-spectra + nPDF}
                    \item {\color{lightgray}\bfseries Moderate effect on $\boldsymbol{R_{AA}}$ compared to nPDFs}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
        ...
        \begin{center}
            ...
            \footnotesize
                \begin{itemize}
                    ...
                    \item {\color{lightgray}\bfseries Large effect on azimuthal correlation $\boldsymbol{\mathcal{C}(\Delta\phi)}$}
                \end{itemize}
                % {\footnotesize\color{lightgray}\texttt{Ballistic diffusion of heavy quarks in \\ the early stage of relativistic heavy \\ ion collisions at RHIC and LHC}}
        \end{center}
        \column{.02\textwidth}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                bubble center node color=gray!10,      
                set color list={palblue!25}
                }
            \smartdiagramadd[bubble diagram]{
                \textbf{Pre-equilibrium}, \textit{\footnotesize\color{palblue}Part 2}\\\textbf{\Large\color{palblue} EKT}
            }{}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \blfootnote{\scriptsize Schlichting, Teaney \href{https://arxiv.org/abs/1908.02113}{{\color{isgold}\texttt{[1908.02113]}$^\text{\tiny\faExternalLink}$}}}
    \begin{tikzpicture}[overlay, remember picture]
        \node[anchor=north west] 
...
\begin{frame}
    ...
    \begin{columns}[onlytextwidth,t]
       ...
       \begin{figure}
            ...
            \includegraphics[width=0.95\textwidth]{images/cdplot_4.eps}
        \end{figure}
        \column{.02\textwidth}
        \column{.5\textwidth}
        \vspace{0.2cm}
    ...
    \blfootnote{\scriptsize \scriptsize Arnold, Moore, Yaffe \href{https://arxiv.org/abs/hep-ph/0209353}{{\color{isgold}\texttt{[hep-ph/0209353]}$^\text{\tiny\faExternalLink}$}} \scriptsize Kurkela, Zhu \href{https://arxiv.org/abs/1506.06647}{{\color{isgold}\texttt{[1506.06647]}$^\text{\tiny\faExternalLink}$}}}
\end{frame}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{center}
        \begin{figure}
            \smartdiagramset{
                bubble center node color=gray!20,      
                set color list={palblue!40, palteal!30, palviolet!30}
                }
            \smartdiagramadd[bubble diagram]{
                \textit{Hard probes} \\ in \textbf{pre-equilibrium}, \textit{\footnotesize\color{palblue}Part 2}\\\textbf{\Large\color{palblue} EKT}, \textit{\color{palteal}Jet} quenching, \textit{\color{palviolet}Heavy quark}\\ diffusion
            }{}
            \begin{tikzpicture}[remember picture,overlay]
                \draw[myarrow, draw=palblue!80, line width=1.5pt, bend right=40]
                (module2) to (module3);
                \draw[myarrow, draw=palblue!80, line width=1.5pt, bend left=40]
                (module2) to (module4);
                % \draw[myarrow, draw=palblue!70, line width=1.5pt, bend left=15]
                % (module5) to (module4);
                % \draw[myarrow, draw=palblue!70, line width=1.5pt, bend right=15]
